...
- **How you learn:** structured daily lessons, a canonical knowledge check per lesson, a progress-aware roadmap that tracks what you've passed and what unlocks next, an interactive concept graph, and an AI tutor (oxtutor) that re-explains concepts and quizzes you.
...
Open the **Roadmap** in the site to see the full 50-day path with your progress: what you've passed, where you are, and what unlocks next. Click any session to open its lesson, then take the knowledge check at the bottom. The **Interactive Concept Graph** (Plan tab) shows how the concepts depend on one another.
...
| Roadmap - progress-aware sitemap | Lesson page |
|----------------------------------|-------------|
| [![Roadmap](docs/assets/screenshots/roadmap.png)](docs/assets/screenshots/roadmap.png) | [![Lesson page](docs/assets/screenshots/lesson.png)](docs/assets/screenshots/lesson.png) |

| Weekly knowledge check | Interactive concept graph |
|------------------------|---------------------------|
| [![Knowledge check](docs/assets/screenshots/knowledge-check.png)](docs/assets/screenshots/knowledge-check.png) | [![Concept graph](docs/assets/screenshots/concept-graph.png)](docs/assets/screenshots/concept-graph.png) |
...
```
 You (student)
     ...
     ▼
 Local lesson site  ─────────►  Roadmap · lessons · knowledge checks
...
| A knowledge check says `Not recorded — Your GitHub account's primary email is now …` | Your GitHub **primary** email is not your college address, so progress can't be counted. Open **github.com/settings/emails**, make sure `<your-roll-number>@andhrauniversity.edu.in` is listed, verified and set as **Primary**, then sign out and back in on the lesson site and retake the check. Attempts you already recorded are safe. |
...
- `docs/kb/` - the interactive concept graph, glossary, and concept library
