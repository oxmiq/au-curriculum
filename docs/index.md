# Oxmiq × Andhra University Internship

<div class="ox-hero" markdown="0">
...
<div class="ox-card-grid" markdown="0">
  <a class="ox-card" href="lessons/week-01/" style="--i:1">
    <span class="ox-card__eyebrow">Begin</span>
    <h3 class="ox-card__title">Week 1 - Orientation</h3>
  ...
  <a class="ox-card" href="kb/interactive-graph/" style="--i:3">
    ...
    <span class="ox-card__cta">Open graph →</span>
  </a>
</div>

## Useful links

- **[Roadmap](roadmap.md)** - the full 50-day path with your progress overlaid: what you've passed, where you are, and what unlocks next.
- **[Concept graph](kb/interactive-graph.md)** - every concept and how they depend on each other; follow the arrows.
