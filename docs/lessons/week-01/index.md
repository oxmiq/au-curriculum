...
| 5 (Fri) | **Consolidation** — quiz + open lab | — | [knowledge-check.html](knowledge-check.html) |

## Friday — the bar

- **[Take the canonical quiz](knowledge-check.html)** — 15 questions across shell, git, and GPU primer. Pass = 10/15.
- **[Assignment](assignment.md)** — three-sentence description of what Capsule is, due end of Day 1; revisited in Week 8 to see how your mental model changed.
