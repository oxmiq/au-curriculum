...
| 2 (Tue) | Shell & Linux | MIT Missing Semester - Shell | [Day 2 · Shell And Linux](module-2/index.md) |
| 3 (Wed) | Git Workflow | Atlassian Git Tutorial | [Day 3 · Git Workflow](module-3/index.md) |
| 4 (Thu) | How Computers Run AI | 3B1B-style GPU video | [Day 4 · How Computers Run Ai](module-4/index.md) |
| 5 (Fri) | **Consolidation**: quiz + open lab | - | [module-5/index.md](module-5/index.md) |

## Friday - the bar

- **[Take the canonical quiz](module-5/knowledge-check.md)**: 15 questions across shell, git, and GPU primer. Pass = 10/15.
