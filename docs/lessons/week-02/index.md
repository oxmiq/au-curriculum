...
| 10 (Fri) | **Consolidation** — Feynman teach-back + quiz | — | [knowledge-check.html](knowledge-check.html) |

## Friday — the bar

- **Canonical [quiz](knowledge-check.html):** GPU anatomy + memory hierarchy + bottleneck classification. Drawn from Flashcards Days 6–9.
